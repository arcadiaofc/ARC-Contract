//Telegram :   https://t.me/arcadiachain
//website  :   https://arcadiachain.org
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x06a0674e1861eDd3b160a34D2A246ADFB950900A; 
...
contract ArcadiaChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Arcadia Chain";
    string private _symbol = "ARC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2B9440B5A3C647CB8ab7f516c10399d1BBD01751); // 
    address payable public teamWalletAddress = payable(0x62f6aA01767BA2f8853806c6Aaf40D5CFBC2Ec1b); // 
